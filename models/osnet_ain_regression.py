...
pretrained_urls = {
    'osnet_ain_x1_0':
    'https://erniumodel.cdn.bcebos.com/osnet_ain_x1_0_imagenet.pth',
    'osnet_ain_x0_75':
    ...
    'osnet_ain_x0_25':
    'https://erniumodel.cdn.bcebos.com/osnet_ain_x0_25_imagenet.pth',
    # 'osnet_ain_x0_75':
    # 'https://erniumodel.cdn.bcebos.com/osnet_ain_x0_75_place365.pkl'
}
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.fc = self._construct_fc_layer(
            self.feature_dim, channels[3], dropout_p=dropout_p
        )
        # identity classification layer
        self.classifier = nn.Linear(self.feature_dim, num_classes)
        self.Regression = torch.nn.Sequential(
                                torch.nn.Linear(channels[3],100),
                                torch.nn.ReLU(),
