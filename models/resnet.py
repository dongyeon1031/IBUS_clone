...
def resnet18(num_classes, loss='softmax', pretrained=True,dropout_p=0.0, **kwargs):
    model = ResNet(
...
def resnet50(num_classes, loss='softmax', pretrained=True,dropout_p=0.0, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet101(num_classes, loss='softmax',dropout_p=0.0, pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet152(num_classes, loss='softmax', pretrained=True,dropout_p=0.0, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
